...
// A COMPLETER :
#define U_PLEINE_ECH_mV 0 //tension de pleine échelle des ADC, exprimée en mV
#define ADC_RESOLUTION_uV 0 //résolution de l'ADC en uV = 1000*U_PLEINE_ECH_mV/2^ADC_NB_BIT = 805.6 µV
#define OFFSET_Iph_MEAS_uV 0 //offset pour la lecture des courants de phase, exprimé en mV
#define OFFSET_Iph_MEAS_mV 0 //offset pour la lecture des courants de phase, exprimé en mV
#define GAIN_Iph_MEAS_VV 0 //gain en V/V pour la lecture des courants de phase
#define GAIN_Iph_MEAS_mVuV 0 //gain en mV/µV pour la lecture des courants de phase
#define GAIN_RES_Iph_MEAS_mVuV 0 //gain + effet résistance de shunt en mV/µV pour la lecture des courants de phase
#define GAIN_RES_Iph_MEAS_VuV 0 //gain + effet résistance de shunt en V/µV pour la lecture des courants de phase
