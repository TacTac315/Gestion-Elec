...
uint16_t DutyDefaultGD3000; //rapport cyclique par défaut (en nb de clock submodule)
uint32_t DeadTime_PWM; ////valeur du deadtime (réglé au niveau du module FlexPWM), donné en nb de périodes
		//d'horloge MOTC (fréq = 40 MHz --> période = 25 ns). Même valeur pour fronts montants et descendants
uint8_t Align_PWM; //réglage de l'alignement de la PWM : CENTER_ALIGN ou EDGE_ALIGN
...
uint8_t gd3000_Config_Init(void) {
	...
	gd3000_Config_FlexPWM0_BrasABC(PWMPeriod,DutyDefaultGD3000,DeadTime_PWM,Align_PWM);
 ...
 * Period_PWM : définit la période de la PWM (donnée en nb de cycles d'horloge du module FlexPWM)
 * DutyCycleStop : définit le rapport cyclique de la PWM en position bloquée (donné en nb de cycles d'horloge du module FlexPWM)
 * DeadTimeVal : définit la valeur du dead time (donné en nb de cycles d'horloge du module FlexPWM)
 * Alignment : définit l'alignement de la PWM : CENTER_ALIGN ou EDGE_ALIGN
 */
/*****************************************************************************/
void gd3000_Config_FlexPWM0_BrasA(uint32_t Period_PWM, uint16_t DutyCycleStop, uint32_t DeadTimeVal, uint8_t Alignment) {
	...
	Config_PWM0_SignalParams(0,OUTPUTA,Period_PWM,DutyCycleStop,DeadTimeVal,Alignment,0,0);
	Config_PWM0_SignalParams(0,OUTPUTB,Period_PWM,DutyCycleStop,DeadTimeVal,Alignment,0,0);
 ...
 */
/*****************************************************************************/
void gd3000_Config_FlexPWM0_BrasABC(uint32_t Period_PWM, uint16_t DutyCycleStop, uint32_t DeadTimeVal, uint8_t Alignment) {
	...
	Config_PWM0_SignalParams(0,OUTPUTA,Period_PWM,DutyCycleStop,DeadTimeVal,Alignment,0,0);
	Config_PWM0_SignalParams(0,OUTPUTB,Period_PWM,DutyCycleStop,DeadTimeVal,Alignment,0,0);
	Config_PWM0_SignalParams(1,OUTPUTA,Period_PWM,DutyCycleStop,DeadTimeVal,Alignment,0,0);
	Config_PWM0_SignalParams(1,OUTPUTB,Period_PWM,DutyCycleStop,DeadTimeVal,Alignment,0,0);
	Config_PWM0_SignalParams(2,OUTPUTA,Period_PWM,DutyCycleStop,DeadTimeVal,Alignment,0,0);
	Config_PWM0_SignalParams(2,OUTPUTB,Period_PWM,DutyCycleStop,DeadTimeVal,Alignment,0,0);
 ...
 * Duty0 : le nouveau rapport cyclique à donner au bras A (donné en nb de cycles d'horloge du module FlexPWM)
 * Period_PWM : définit la période de la PWM (donnée en nb de cycles d'horloge du module FlexPWM)
 * DeadTimeVal : définit la valeur du dead time (donné en nb de cycles d'horloge du module FlexPWM)
 * Alignment : définit l'alignement de la PWM : CENTER_ALIGN ou EDGE_ALIGN                   		 */
/*****************************************************************************/
void gd3000_Update_DutyCycle_Cmd_PWMA(uint16_t Duty0, uint32_t Period_PWM, uint32_t DeadTimeVal, uint8_t Alignment) {
	Config_PWM0_SignalParams(0,OUTPUTA,Period_PWM,Duty0,DeadTimeVal,Alignment,0,0);
	Config_PWM0_SignalParams(0,OUTPUTB,Period_PWM,Duty0,DeadTimeVal,Alignment,0,0);
...
/* Description: met à jour le rapport cyclique de la commande PWM (assuré par*/
/* FlexPWM0.
 * Duty0, Duty1, Duty2 : le nouveau rapport cyclique à donner aux bras A, B et C (donné en nb de cycles d'horloge du module FlexPWM)
 * Period_PWM : définit la période de la PWM (donnée en nb de cycles d'horloge du module FlexPWM)
 * DeadTimeVal : définit la valeur du dead time (donné en nb de cycles d'horloge du module FlexPWM)
 * Alignment : définit l'alignement de la PWM : CENTER_ALIGN ou EDGE_ALIGN  															 */
/*****************************************************************************/
void gd3000_Update_DutyCycle_Cmd_PWM_ABC(uint16_t Duty0, uint16_t Duty1, uint16_t Duty2, uint32_t Period_PWM, uint32_t DeadTimeVal, uint8_t Alignment) {
	Config_PWM0_SignalParams(0,OUTPUTA,Period_PWM,Duty0,DeadTimeVal,Alignment,0,0);
	Config_PWM0_SignalParams(0,OUTPUTB,Period_PWM,Duty0,DeadTimeVal,Alignment,0,0);
	Config_PWM0_SignalParams(1,OUTPUTA,Period_PWM,Duty1,DeadTimeVal,Alignment,0,0);
	Config_PWM0_SignalParams(1,OUTPUTB,Period_PWM,Duty1,DeadTimeVal,Alignment,0,0);
	Config_PWM0_SignalParams(2,OUTPUTA,Period_PWM,Duty2,DeadTimeVal,Alignment,0,0);
	Config_PWM0_SignalParams(2,OUTPUTB,Period_PWM,Duty2,DeadTimeVal,Alignment,0,0);
