...
void Get_Phase_Current_Virtuel(void) {
	...
	Iphase_A_k.fltArg1 = MLIB_Sub_FLT(terme1,terme2); //courant de phase en A (on inverse le signe pour tenir compte
	...
	Iphase_A_k.fltArg2 = MLIB_Sub_FLT(terme1,terme2); //courant de phase en A (on inverse le signe pour tenir compte
	 //de la lecture du courant à travers le shunt)

	terme1 = MLIB_Add_FLT(Uabc_Commande.fltArg3,Uabc_n_1.fltArg3);
	terme1 = MLIB_Mul_FLT(terme1,terme1_calc_courant);
	terme2 = MLIB_Mul_FLT(Iphase_A_k_1.fltArg3,terme2_calc_courant);
	Iphase_A_k.fltArg3 = MLIB_Sub_FLT(terme1,terme2); //courant de phase en A (on inverse le signe pour tenir compte
	 //de la lecture du courant à travers le shunt)
